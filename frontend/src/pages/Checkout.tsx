		...
		<div className="min-h-screen bg-[#020617] text-white font-['Inter'] flex flex-col relative overflow-hidden">
			...
			<main className="grow container mx-auto px-6 py-10 relative z-10 flex items-center justify-center pt-32 pb-20">
				<div className="w-full max-w-lg">
					...
					<div className="bg-[#051329]/80 backdrop-blur-md border border-white/10 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
						<div className="absolute top-0 left-0 right-0 h-1 bg-linear-to-r from-transparent via-[#0753E0] to-transparent opacity-70"></div>
