...
const UserProfileCard: React.FC<UserProfileCardProps> = ({ user, onUpdate }) => {
  ...
  return (
    <div className="bg-linear-to-r from-blue-900/80 to-blue-800/80 rounded-3xl p-8 flex flex-col md:flex-row justify-between gap-6">
      <div className="flex gap-6 w-full">
        <div className="w-20 h-20 rounded-full bg-blue-700 flex items-center justify-center text-3xl font-bold shrink-0 text-white">
      ...
      <div className="flex flex-col gap-3 min-w-35">
        {isEditing ? (
          <>
            <EditButton onClick={handleSave} className="px-6 py-3 w-full">
              Зберегти
            </EditButton>
            <button 
