        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex flex-col gap-2">
                ...
                <input 
                  ...
                  className="w-full bg-white text-black rounded-lg px-4 py-3 outline-none focus:ring-2 focus:ring-blue-500" 
                />
            </div>
            <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2">
                <label className="text-white font-medium ml-1">Пошук фільму</label>
                <input 
                  type="text" 
