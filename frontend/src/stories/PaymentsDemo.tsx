      ...
      <section className="bg-[#051329]/60 backdrop-blur-md border border-white/10 rounded-2xl p-8">
        ...
        <div className="flex flex-col items-center max-w-2xl mx-auto">
           ...
           <div className="relative mb-12 w-full">
              <div className="h-12 w-full bg-gradient-to-b from-[#0753E0]/20 to-transparent transform perspective-[500px] rotate-x-[30deg] rounded-t-[50%] blur-sm"></div>
              <div className="absolute top-0 w-full h-1 bg-gradient-to-r from-transparent via-[#0753E0] to-transparent shadow-[0_0_20px_rgba(7,83,224,0.8)] rounded-full"></div>
